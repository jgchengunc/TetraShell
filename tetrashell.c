      ...
      if (argCount == 0) {
        ...
        while (fgets(output, PATH_MAX + 1, fp) != NULL) {
          if (output[0] == 'r') {
            ...
            // reprints it every 50 quicksaves so you can always see it
            if (recovered % 50 == 0) {
              if (recovered == 0) {
        ...
        if (strcmp(args[1], "m") == 0 || strcmp(args[1], "mo") == 0 ||
                   strcmp(args[1], "mod") == 0 ||
        ...
        } else if (strcmp(args[1], "ra") == 0 || strcmp(args[1], "ran") == 0 ||
